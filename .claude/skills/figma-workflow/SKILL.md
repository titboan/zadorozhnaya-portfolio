...
⚠️ **В локальной сессии на компьютере Бори используй `lunacy-workflow` вместо этого файла** — Lunacy MCP снимает лимит в 6 запросов/месяц, проверено на реальной задаче (2026-07-20). Этот файл остаётся резервным вариантом для облачной сессии (веб/GitHub), где Lunacy недоступен, и для случаев, когда нужного контента ещё нет в Lunacy-копии файла.
...
## Известное будущее
Основной инструмент теперь Lunacy (`lunacy-workflow`, `plans/2026-07-20-workflow-modernization.md`, часть 4) — снимает лимит в 6 запросов/месяц. Penpot остаётся резервным вариантом на случай, если импорт `.fig` в Lunacy заметно потеряет эффекты.
