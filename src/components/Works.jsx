              ...
              <Card slug="poly" mod="poly">
                ...
                <div className="works__split">
                  <div className="works__text">
                    ...
                    <p className="works__desc">{'Фирменная полиграфия является неотъемлемой частью бренда, если у вас уже есть фирменная айдентика, необходимо действовать в её рамках, но при этом сделать дизайн современным и понятным для ЦА.\n\nТакже я даю рекомендации по дальнейшей постпечатной обработке, ориентируясь на бюджет клиента\n\nбуклеты | листовки | визитки | открытки\n| лифлеты | пригласительные'}</p>
                  </div>
              ...
              <Card slug="identity" mod="identity">
                ...
                <div className="works__split">
                  <div className="works__text">
                    ...
                    <p className="works__desc">
                      Глубокое погружение в нишу бизнеса, анализ конкурентов и проработка потенциального клиента помогают разработать айдентику, которая будет задавать необходимое позиционирование бренда на рынке.
                    </p>
                  </div>
                  <div className="works__img-side">
